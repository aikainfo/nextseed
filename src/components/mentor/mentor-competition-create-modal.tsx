...
interface MentorCompetitionCreateModalProps {
    isOpen: boolean
    onClose: () => void
    onCreate: (data: any) => void
}

export const MentorCompetitionCreateModal: React.FC<MentorCompetitionCreateModalProps> = ({
    isOpen,
    onClose,
    onCreate,
}) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Создать конкурс" className="max-w-3xl">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Input
                    label="Призы"
                    placeholder="Например: $5000 + менторство"
