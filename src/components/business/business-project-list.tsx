...
import { BusinessProjectCard } from "./business-project-card"

interface BusinessProjectListProps {
    projects: any[]
    onView: (projectId: string) => void
    onReview: (projectId: string) => void
}

export const BusinessProjectList: React.FC<BusinessProjectListProps> = ({
    projects,
    onView,
    onReview,
}) => {
