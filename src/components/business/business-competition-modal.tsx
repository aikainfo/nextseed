...
interface BusinessCompetitionModalProps {
    isOpen: boolean
    onClose: () => void
    competition: any
...
export const BusinessCompetitionModal: React.FC<BusinessCompetitionModalProps> = ({
    isOpen,
    onClose,
    competition,
    onRegister,
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={competition.title} className="max-w-3xl">
            <div className="space-y-6">
                ...
                <div className="border-t border-surface-100 pt-6 space-y-4">
                    <h3 className="text-lg font-bold text-surface-900">Регистрация бизнес‑участника</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Input
                            label="Имя и фамилия"
                            value={formData.name}
